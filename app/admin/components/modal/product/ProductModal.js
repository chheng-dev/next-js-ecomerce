...
//                       raduis="xl"
//                       value={isEditMode ? product?.name : prodName}
...
//                       className="my-3"
//                       value={isEditMode ? product?.description : description}
...
//                           selectedSizes={isEditMode ? product?.sizes : selectedSizes}
...
//                           placeholder="0.00"
//                           labelPlacement="outside"
//                           value={isEditMode ? product?.ori_price : priceData.oriPrice}
//                           onChange={(e) => onChangeOriPrice('oriPrice', e.target.value)}
//                           isRequired
...
//                                 {isEditMode ? product?.ori_currency === 'usd' ? '$' : '៛' : priceData.oriCurrency === 'usd' ? '$' : '៛'}
//                               </span>
//                             </div>
//                           }
//                           endContent={
...
//                                 id="currency-ori"
//                                 name="oriCurrency"
//                                 value={isEditMode ? product?.ori_currency : priceData.oriCurrency}
...
//                           placeholder="0.00"
//                           labelPlacement="outside"
//                           value={isEditMode ? product?.price : priceData.price}
...
//                             <div className="pointer-events-none flex items-center">
//                               <span className="text-default-400 text-small">
//                                 {isEditMode ? product?.currency === 'usd' ? '$' : '៛' : priceData.currency === 'usd' ? '$' : '៛'}
//                               </span>
//                             </div>
//                           }
//                           endContent={
...
//                                 id="currency-price"
//                                 name="currency"
//                                 value={isEditMode ? product?.currency : priceData.currency}
...
//                           raduis="xl"
//                           isRequired
//                           value={isEditMode ? product?.stock_quantity : stock}
...
//                           placeholder="0%"
//                           labelPlacement="outside"
//                           value={isEditMode ? product?.discount : discount}
//                           endContent={
//                             <div className="pointer-events-none flex items-center">
...
//                         selectedValueCategory={isEditMode ? generateSlug(product?.category.label) : selectedCategoryId}
//                         onSelectionChangeCategory={onSelectionChangeCategory}
//                       />
//                       <SelectedBrandComp
//                         isInvalidBrand={isInvalidBrand}
//                         selectedValueBrand={isEditMode ? product?.brand.key : selectedBrandValue}
